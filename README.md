...
2.  **Brand Fetching:** It retrieves a "Regional Brand List"—a curated collection of 100+ verified brands popular and available in that specific territory (e.g., _Nivea, Simple, Arami, CeraVe_ for Nigeria).
3.  **AI Constraint Reasoning:** The **Gemini 3 Flash** engine uses this list as a strict boundary. It evaluates the user's skin needs and recommends specific, high-performing products _only_ from those verified companies.
...
- **Personalized Roadmaps:** Access structured, outcome-driven skincare protocols such as _Clear Dark Spots_, _Lighten Up_, or _Smoothing_. These are not static plans; they are dynamically calibrated based on your unique skin profile, local humidity, and real-time environmental UV indexes.
...
## � Future Vision & Incubation

The following features represent the long-term strategic evolution of the Skinalo ecosystem, focusing on community validation and verified clinical results.

### 🏆 The Radiance Leaderboard (Global Transformation Board)

**Concept:** A viral, gamified community loop designed to showcase the true efficacy of the Skinalo ecosystem through verified user journeys. This is not a beauty pageant; it is a clinical competition rooted in data-driven skin healing.

#### **Core Mechanics & Governance**

- **The Qualifier (Proof of Progress):** Entry is strictly limited to users who have completed a verified **28-day Beautify 'Progress Board'**. Raw, unverified selfies are automatically rejected. All entries must consist of AI-tracked clinical journeys, ensuring that transformations are measurable and authentic.
- **National Heats:** A localized voting board where the community evaluates the most impressive, verifiable skin transformations within their specific country (e.g., Nigeria). This stage drives organic social sharing as users campaign for community validation of their healing journey.
- **The Global Stage:** The Top 3 transformations from each National Heat advance to the **Global Radiance Board**. Here, they compete on an international level, representing the clinical excellence of their region.
- **The Reward (Verified Authority):** Top-ranking users earn the prestigious **'Skinalo Ambassador'** badge and eligibility for sponsored product bundles. These rewards serve as professional endorsements, proving that the AI Skin Coach delivers tangible, clinical-grade results.

**Status:** Strategic Roadmap / Planned Future Deployment.
